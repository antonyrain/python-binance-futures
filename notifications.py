...
class Text:
    ...
    notice_1 = f"""NOTICE:\nThe trigger price of a hedging short/long orders
...
to open positions in a futures market
and almost immediately hedging with
the opposite orders, placed with a trigger
